var moduleManager = require(__dirname+'/module_manager');
...
JarvisMessage.prototype.reply = function( cnt ) {
    ...
    if ( this.content.hasOwnProperty("action") )
        m.content.action = this.content.action;
    if ( this.content.hasOwnProperty("messageid") )
        m.content.messageid = this.content.messageid;
